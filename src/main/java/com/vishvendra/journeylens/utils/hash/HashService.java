package com.vishvendra.journeylens.utils.hash;
...
public class HashService {
  ...
  public String hashApiKey(String apiKey, String salt) {
    try {
  ...
  public boolean verifyApiKey(String apiKey, String hashedApiKey, String salt) {
